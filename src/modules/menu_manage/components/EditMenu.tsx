...
import { 
    ...
    Switch, Card, Breadcrumb, message 
} from 'antd';
...
export default function EditMenuPage() {
    ...
    const { data: menuDetail, isPending: isLoadingDetail } = useGetMenuDetail(id!);
    ...
    useEffect(() => {
        if (menuDetail?.data) {
            ...
            form.setFieldsValue({
                ...
                recipes: menu.recipes?.map((r: any) => r._id || r),
                servings: menu.meta?.servings,
                cookType: menu.meta?.cookType,
                isPrepped: menu.meta?.isPrepped,
            });
